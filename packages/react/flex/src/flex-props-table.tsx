...
export const flexProps = [
  ...
  { param: 'display', desc: 'CSS display属性', type: "'none' | 'inline-flex' | 'flex'", defaultValue: "'flex'", version: '0.2.0' },
  { param: 'direction', desc: 'CSS flex-direction属性', type: "'row' | 'column' | 'row-reverse' | 'column-reverse'", defaultValue: "'row'", version: '0.2.0' },
  { param: 'align', desc: 'CSS align-items属性', type: "'start' | 'center' | 'end' | 'baseline' | 'stretch'", defaultValue: "'start'", version: '0.2.0' },
  { param: 'justify', desc: 'CSS justify-content属性', type: "'start' | 'center' | 'end' | 'between'", defaultValue: "'start'", version: '0.2.0' },
  { param: 'wrap', desc: 'CSS flex-wrap属性', type: "'nowrap' | 'wrap' | 'wrap-reverse'", defaultValue: "'nowrap'", version: '0.2.0' },
...
// API文档组件
export const FlexPropsComponent: React.FC = () => {
  return (
    <Box p="5" style={{ maxWidth: '900px' }}>
      <ApiTable title="Flex Props" data={flexProps} />
    </Box>
  );
}; 