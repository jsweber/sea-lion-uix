...
export const headingProps = [
  { param: 'as', desc: '要渲染的HTML元素', type: "'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6'", defaultValue: "'h1'", version: '0.2.0' },
  { param: 'asChild', desc: '是否将组件作为子元素传递', type: 'boolean', defaultValue: 'false', version: '0.2.0' },
  { param: 'size', desc: '标题文本尺寸', type: "'1' - '9'", defaultValue: "'6'", version: '0.2.0' },
  { param: 'weight', desc: '文本粗细', type: "'light' | 'regular' | 'medium' | 'bold'", defaultValue: "'bold'", version: '0.2.0' },
  { param: 'align', desc: '文本对齐方式', type: "'left' | 'center' | 'right'", defaultValue: "-", version: '0.2.0' },
  { param: 'color', desc: '文本颜色', type: "'gray' | 'blue' | 'green' | ... (主题色)", defaultValue: "-", version: '0.2.0' },
  { param: 'highContrast', desc: '是否使用高对比度颜色', type: "boolean", defaultValue: "false", version: '0.2.0' },
  { param: 'truncate', desc: '是否截断文本并显示省略号', type: "boolean", defaultValue: "false", version: '0.2.0' },
  { param: 'textWrap', desc: '文本换行行为', type: "'wrap' | 'nowrap' | 'balance' | 'pretty'", defaultValue: "-", version: '0.2.0' },
  { param: 'leadingTrim', desc: '是否应用前导修整', type: "boolean", defaultValue: "true", version: '0.2.0' },
...
// API文档组件
export const HeadingPropsComponent: React.FC = () => {
  return (
    <Box p="5" style={{ maxWidth: '900px' }}>
      <ApiTable title="Heading Props" data={headingProps} />
    </Box>
  );
}; 