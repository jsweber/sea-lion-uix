...
// RadioGroup.Root 组件属性
export const radioGroupRootProps = [
    { param: 'size', desc: '单选按钮尺寸', type: "'1' | '2' | '3'", defaultValue: "'2'", version: '0.2.0' },
    { param: 'variant', desc: '变体样式', type: "'classic' | 'surface' | 'soft'", defaultValue: "'surface'", version: '0.2.0' },
    ...
    { param: 'value', desc: '当前选中的值', type: "string", defaultValue: "-", version: '0.2.0' },
    { param: 'defaultValue', desc: '默认选中的值', type: "string", defaultValue: "-", version: '0.2.0' },
    { param: 'onValueChange', desc: '值变化时的回调', type: "(value: string) => void", defaultValue: "-", version: '0.2.0' },
    { param: 'disabled', desc: '是否禁用整个组', type: "boolean", defaultValue: "false", version: '0.2.0' },
    { param: 'name', desc: '表单名称', type: "string", defaultValue: "-", version: '0.2.0' },
    { param: 'required', desc: '是否必选', type: "boolean", defaultValue: "false", version: '0.2.0' },
];

// RadioGroup.Item 组件属性
export const radioGroupItemProps = [
    ...
    { param: 'children', desc: '子元素', type: "React.ReactNode", defaultValue: "-", version: '0.2.0' },
];

// API文档组件
export const RadioGroupPropsComponent: React.FC = () => {
    return (
        <Box p="5" style={{ maxWidth: '900px' }}>
            <ApiTable title="RadioGroup.Root Props" data={radioGroupRootProps} />
            <ApiTable title="RadioGroup.Item Props" data={radioGroupItemProps} />
        </Box>
    );
};
