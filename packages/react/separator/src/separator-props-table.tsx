...
export const separatorProps = [
    { param: 'orientation', desc: '分隔线方向', type: "'horizontal' | 'vertical'", defaultValue: "'horizontal'", version: '0.2.0' },
    { param: 'size', desc: '分隔线尺寸', type: "'1' | '2' | '3' | '4'", defaultValue: "'1'", version: '0.2.0' },
    { param: 'color', desc: '分隔线颜色', type: "string", defaultValue: "'gray'", version: '0.2.0' },
    { param: 'decorative', desc: '是否为装饰性元素', type: "boolean", defaultValue: "true", version: '0.2.0' },
];

// API文档组件
export const SeparatorPropsComponent: React.FC = () => {
    return (
        <Box style={{ maxWidth: '900px' }}>
            <ApiTable title="Separator 属性" data={separatorProps} />
        </Box>
    );
};
