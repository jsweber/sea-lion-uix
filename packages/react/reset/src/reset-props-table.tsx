...
export const resetProps = [
    { param: 'children', desc: '需要重置样式的内容', type: "React.ReactNode", defaultValue: "-", version: '0.2.0' },
    { param: 'asChild', desc: '是否作为子元素渲染', type: "boolean", defaultValue: "false", version: '0.2.0' },
];

// API文档组件
export const ResetPropsComponent: React.FC = () => {
    return (
        <Box p="5" style={{ maxWidth: '900px' }}>
            <ApiTable title="Reset Props" data={resetProps} />
        </Box>
    );
};
