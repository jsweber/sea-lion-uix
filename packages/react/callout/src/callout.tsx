...
import { calloutRootPropDefs, mapCalloutSizeToTextSize } from './callout.props';
...
interface CalloutContextValue { size?: CalloutRootOwnProps['size'] }
...
type CalloutIconProps = ComponentPropsWithout<'div', RemovedProps>
