...
type HoverCardRootProps = React.ComponentPropsWithoutRef<typeof HoverCardPrimitive.Root>
...
type HoverCardTriggerProps = ComponentPropsWithout<typeof HoverCardPrimitive.Trigger, RemovedProps>
