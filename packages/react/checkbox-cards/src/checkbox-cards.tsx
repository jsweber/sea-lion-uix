...
import { primitive } from '@sea-lion/react-checkbox-group';
...
import { ThickCheckIcon } from '@sea-lion/react-icon';
...
import type { MarginProps, Responsive, GetPropDefTypes } from '@sea-lion/react-props';

const CHECKBOX_CARD_GROUP_NAME = 'CheckboxCards';
const { createCheckboxGroupScope } = primitive;
const CheckboxGroupPrimitive = primitive;
