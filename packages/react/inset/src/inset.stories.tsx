            ...
            <Box p="5">
                ...
                <Flex direction="column" gap="6">
                    <Box>
                        ...
                        <Box style={{ maxWidth: '500px', borderRadius: '8px', overflow: 'hidden', border: '1px solid var(--gray-5)' }}>
                            <Inset side="top">
                                <Box style={{ height: '80px', background: 'var(--blue-5)', width: '100%' }} />
                            </Inset>
                            <Box p="4">
                    ...
                    <Box>
                        ...
                        <Box style={{ maxWidth: '500px', borderRadius: '8px', overflow: 'hidden', border: '1px solid var(--gray-5)' }}>
                            ...
                            <Inset side="bottom">
                                <Box style={{ height: '80px', background: 'var(--green-5)', width: '100%' }} />
                            </Inset>
                        </Box>
                    </Box>
                    ...
                    <Flex gap="4">
                        <Box style={{ flex: 1 }}>
                            ...
                            <Box style={{ maxWidth: '250px', height: '200px', borderRadius: '8px', overflow: 'hidden', border: '1px solid var(--gray-5)', display: 'flex' }}>
                                <Inset side="left">
                                    <Box style={{ width: '80px', height: '100%', background: 'var(--amber-5)' }} />
                                </Inset>
                        ...
                        <Box style={{ flex: 1 }}>
                            ...
                            <Box style={{ maxWidth: '250px', height: '200px', borderRadius: '8px', overflow: 'hidden', border: '1px solid var(--gray-5)', display: 'flex' }}>
                                ...
                                <Inset side="right">
                                    <Box style={{ width: '80px', height: '100%', background: 'var(--purple-5)' }} />
                                </Inset>
                            </Box>
                        </Box>
                    </Flex>
                    ...
                    <Box>
                        ...
                        <Box style={{ maxWidth: '500px', borderRadius: '8px', overflow: 'hidden', border: '1px solid var(--gray-5)' }}>
                            <Inset side="x">
                                <Box style={{ height: '80px', background: 'var(--red-5)', width: '100%' }} />
                            </Inset>
                            <Box p="4">
                    ...
                    <Box>
                        ...
                        <Box style={{ maxWidth: '500px', borderRadius: '8px', overflow: 'hidden', border: '1px solid var(--gray-5)', display: 'flex' }}>
                            <Inset side="y">
                                <Box style={{ width: '80px', height: '200px', background: 'var(--blue-5)' }} />
                            </Inset>
                            <Box p="4" style={{ flex: 1 }}>
                    ...
                    <Box>
                        ...
                        <Box style={{ maxWidth: '500px', borderRadius: '8px', overflow: 'hidden', border: '4px solid var(--gray-5)' }}>
                            <Inset clip="border-box">
                                <Box style={{ height: '120px', background: 'var(--amber-5)', width: '100%' }} />
                            </Inset>
                            <Box p="4">
                    ...
                    <Box>
                        ...
                        <Box style={{ maxWidth: '500px', borderRadius: '8px', overflow: 'hidden', border: '4px solid var(--gray-5)' }}>
                            <Inset clip="padding-box">
                                <Box style={{ height: '120px', background: 'var(--green-5)', width: '100%' }} />
                            </Inset>
                            <Box p="4">
