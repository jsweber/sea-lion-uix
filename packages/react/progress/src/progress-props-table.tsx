...
export const progressProps = [
  { param: 'size', desc: '进度条尺寸', type: "'1' | '2' | '3'", defaultValue: "'2'", version: '0.2.0' },
  ...
  { param: 'radius', desc: '圆角半径', type: "'none' | 'small' | 'medium' | 'large' | 'full'", defaultValue: "-", version: '0.2.0' },
  { param: 'duration', desc: '动画持续时间', type: "`${number}s` | `${number}ms`", defaultValue: "'5s'", version: '0.2.0' },
  { param: 'value', desc: '当前进度值', type: "number", defaultValue: "-", version: '0.2.0' },
  { param: 'max', desc: '最大进度值', type: "number", defaultValue: "100", version: '0.2.0' },
];

// API文档组件
export const ProgressPropsComponent: React.FC = () => {
  return (
    <Box p="5" style={{ maxWidth: '900px' }}>
      <ApiTable title="Progress Props" data={progressProps} />
    </Box>
  );
}; 